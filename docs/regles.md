...
| G4-e | Quand la capture parle de la date de naissance de quelqu'un. | Il faut décider si l'on émet has_birthday et avec quelle certitude. | Regarder D'ABORD la date elle-même : une date seulement déduite d'un repère (« demain », « mardi », « ce week-end ») n'est JAMAIS explicite, si clairement que la phrase énonce l'anniversaire ; la résoudre et l'émettre en implicite. Puis trois cas, qui se distinguent par la SOURCE de la date et jamais par les mots employés. **La date est ÉNONCÉE directement**, que ce soit une naissance datée (« né le 12 juin 1990 ») ou un anniversaire posé avec son jour et son mois (« le 27 juillet c'est l'anniversaire de Léon ») → has_birthday, explicite : la capture dit le jour, il n'y a rien à deviner, et le doute qui reste porte sur la FÊTE, pas sur la date. **La date est LUE SUR UNE FÊTE** (« la fête d'anniversaire de Yanis est le 12 juin ») → has_birthday quand même, implicite, pour qu'elle parte en validation : une fête tombe souvent le jour même, pas toujours. **Aucune date n'est donnée, seulement un ÂGE** (« Tom a fêté ses 30 ans ») → pas de has_birthday du tout ; en déduire l'année serait de l'invention déguisée en arithmétique, fausse une année sur deux. L'âge garde son propre fait. | garantie · prompt |
